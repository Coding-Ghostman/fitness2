...
const Card = ({ title, image, link }) => {
    return (
        <Tilt className="flex-1 p-8" options={{ max: 25 }}>
            <div data-type={title} className="relative block w-full h-full rounded-xl overflow-hidden cursor-pointer interactable">
