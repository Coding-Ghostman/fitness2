...
function Panel() {
    ...
    return (
        <div className="relative bg_panel">
            <div className="xl:w-[35vw] lg:w-[40vw] sm:w-[50vw] w-[100vw] h-[109vh] float-right bg-slate-700 overflow-y-auto overflow-x-hidden z-10 box__shadow rounded-xl flex flex-col">
                <div
